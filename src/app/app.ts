 ...
 * I want to have the header and subheader text animate onto the page upon page load
...
@Component({
  ...
  template: `
            <div class="fullscreenContainer">
              ...
              <p class="subHeaderText">I am a fourth year Informatics student at Indiana University, graduating in May 2026.</p>
              <p class="subHeaderText">This website hosts some of my work and a little bit about me!<p>
            </div>`,
  styleUrl: './app.css'
})
export class App {
  protected readonly title = signal('Gavin or other Viewer');
}
